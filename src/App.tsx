...
const App: React.FC = () => {
    return (
        <Router>
            <Routes>
                {/* LOGIN ONLY (admin/driver) */}
                <Route path="/" element={<Auth />} />

                {/* SIGNUP PAGES */}
                <Route path="/superadmin" element={<SuperadminSignupAuth />} />
                <Route path="/signup/admin" element={<AdminSignupAuth />} />
                <Route path="/signup/driver" element={<DriverSignupAuth />} />
